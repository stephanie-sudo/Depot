...
export default function Footer() {
  ...
  return (
    <>
      <Box as="footer" bg="primary.500" color="contrastText" pt={8} pb={8}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/contact" className="text-gray-400 hover:text-white transition">{tNav('contact')}</Link></li>
            </ul>
          </div>

          {/* Legal */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">{tFooter('legal')}</h3>
            <ul className="space-y-2">
              <li><Link href="/impressum" className="text-gray-400 hover:text-white transition">{tLegal('impressum')}</Link></li>
              <li><Link href="/privacy" className="text-gray-400 hover:text-white transition">{tLegal('privacy')}</Link></li>
            </ul>
          </div>
        </div>
      </div>
